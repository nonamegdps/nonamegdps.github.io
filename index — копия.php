    ...
    <script>
        function str() {
            ...
            if (a == "DOMAIN/accounts/registerGJAccount.php" || a == undefined) {
                ...
                location.href = 'set?set=3&site=' + a + "&is=1";
            }
        }
        ...
        function strs() {
            ...
            if (a == "DOMAIN/accounts/registerGJAccount.php" || a == undefined) {
                ...
                location.href = 'set?set=1&site=' + a;
            }
        }
        ...
        function stsrs() {
            ...
            if (a == "DOMAIN/updateGJUserScore22.php" || a == undefined) {
                ...
                location.href = 'set?set=2&site=' + a;
            }
        }
    </script>
    <p><?php
...
$result = mysqli_query($link, "SELECT * FROM view");
$view = mysqli_num_rows($result);
echo "$view stats requests sent | ";
$result = mysqli_query($link, "SELECT * FROM view1");
$view = mysqli_num_rows($result);
echo "$view accounts created | ";
$result = mysqli_query($link, "SELECT * FROM view2");
$view = mysqli_num_rows($result);
echo "$view levels created";
